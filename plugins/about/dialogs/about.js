				...
				elements: [
					{
						...
						html:
							...
							"<div>" +
							'<div class="title" style="margin-bottom: 10px;font-weight: 600;">Фишинг</div>' +
							...
							'<div class="title" style="margin-bottom: 10px;margin-top: 10px;font-weight: 600;">Редактор шаблонов:</div>' +
